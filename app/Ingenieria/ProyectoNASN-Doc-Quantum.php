...
<head>
    ...
    <title>Proyecto NAS N+ doc-quantum</title>
            ...
            <div class="col-auto">
                ...
                <div class="collapse navbar-collapse" id="navbarsdoc">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="ProyectoNASN-Doc-Quantum.php">Doc Oficial
                                Quantum</a>
                        </li>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ProyectoNASN-Sas.php">Conexión Cables SAS</a></li>
            ...
            <div class="col">
                ...
                <div class="card mb-3 mt-3">
                    <div class="card-header text-univision fw-bold ">
                        Documento Oficial de Quantum.
                    </div>
                    <div class="card-body p-2">

                        <div id="miPDF" class="row p-3  justify-content-center">

                            <iframe src="../Doc/Televisa Noticieros.pdf" class="w-100" frameborder="0"></iframe>
