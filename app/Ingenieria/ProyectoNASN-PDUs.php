...
<head>
    ...
    <title>Proyecto NAS N+ PDUs</title>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ProyectoNASN-UTP-Management.php">Conexión UTP
                                        Management</a></li>
                                <li><a class="dropdown-item active" href="ProyectoNASN-PDUs.php">PDUs</a></li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/PDUs.pdf" class="w-100" frameborder="0"></iframe>
