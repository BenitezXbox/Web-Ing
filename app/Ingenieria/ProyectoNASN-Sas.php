...
<head>
    ...
    <title>Proyecto NAS N+ Sas</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item active" href="ProyectoNASN-Sas.php">Conexión Cables SAS</a>
                                </li>
                ...
                <div class="card mb-3 mt-3">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-SAS img-fluid border">
