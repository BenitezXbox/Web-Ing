...
<head>
    ...
    <title>Proyecto NAS N+ Logs</title>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ProyectoNASN-GenGrupos.php">Generacion Grupos
                                        Usuarios</a></li>
                                <li><a class="dropdown-item active" href="ProyectoNASN-Logs.php">Recoleccion Logs</a>
                                </li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe
                                    src="../Doc/PROCEDIMIENTO Recolección de LOGS del Sistema para su posterior envío al fabricante.pdf"
