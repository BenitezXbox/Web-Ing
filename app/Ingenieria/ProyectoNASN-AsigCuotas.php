...
<head>
    ...
    <title>Proyecto NAS N+ Asig Cuotas</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item active" href="ProyectoNASN-AsigCuotas.php">Asignacion de
                                        Cuotas a
                                        carpetas
                                    </a></li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/PROCEDIMIENTO ASIGNACION CUOTAS A CARPETAS COMPARTIDAS SHARINGS.pdf"
