...
<head>
    ...
    <title>Proyecto NAS N+ Share Point</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="ProyectoNASN-Share-Point.php">Share Point</a>
                        </li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/Share Point.pdf" class="w-100" frameborder="0"></iframe>
