...
<head>
    ...
    <title>Proyecto NAS N+ Fiber Channel</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="ProyectoNASN-FiberChannel.php">Conexión de
                                        Fibre Channel </a></li>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ProyectoNASN-Disk.php">Cambio Disco H4000</a></li>
                                <li><a class="dropdown-item active" href="ProyectoNASN-DiskStornext.php">Cambio Disco
                                        Stornext</a></li>
            ...
            <div class="col">
                ...
                <div class="card mb-3 mt-3">
                    <div class="card-header text-univision fw-bold ">
                        Conexión de fiber channel.
                    </div>
                    <div class="card-body p-2">

                        <div class="row p-3 pb-4 justify-content-center">

                            <img alt="image" class="img-Fiber img-fluid border">
        ...
        <div class="row  pt-3">
            ...
            <div class="col">
                ...
                <div class="card mb-3 mt-3">
                    <div class="card-header text-univision fw-bold ">
                        Listado de cableado - Brocade DCX 8510-8.
                    </div>
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/DCX 8510.pdf" class="w-100" frameborder="0"></iframe>
        ...
        <div class="row  pt-3">
            ...
            <div class="col">
                ...
                <div class="card mb-3 mt-3">
                    <div class="card-header text-univision fw-bold ">
                        Listado de cableado - Blackdiamond 8810.
                    </div>
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/Extreme BD 8810.pdf" class="w-100" frameborder="0"></iframe>
        ...
        <div class="row  pt-3">
            ...
            <div class="col">
                ...
                <div class="card mb-3 mt-3">
                    <div class="card-header text-univision fw-bold ">
                        Listado de cableado - Brocade DS 6520B.
                    </div>
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/DS_6520B.pdf" class="w-100" frameborder="0"></iframe>
