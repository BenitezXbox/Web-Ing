...
<head>
    ...
    <title>Proyecto NAS N+ Racks</title>
        ...
        <nav class="row navbar navbar-expand-lg navbar-light justify-content-between align-items-center text-uppercase bg-light"
            ...
            <div class="col-auto">
                ...
                <div class="collapse navbar-collapse" id="navbarsdoc">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link active" aria-current="page" href="proyectoNASN-Racks.php">Racks</a>
                        </li>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="ProyectoNASN-Sas.php">Conexión Cables
                                        SAS</a></li>
                                <li><a class="dropdown-item" href="ProyectoNASN-FiberChannel.php">Conexión de Fibre
                                        Channel </a></li>
                ...
                <div class="card mb-3 mt-3">
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks1 img-fluid border">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks2 img-fluid border">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks3 img-fluid border">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks4 img-fluid border">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks5 img-fluid border">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <img alt="image" class="img-Racks6 img-fluid border">
