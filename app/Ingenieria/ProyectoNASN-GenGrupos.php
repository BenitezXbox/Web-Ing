...
<head>
    ...
    <title>Proyecto NAS N+ Gneracion Grupos</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="ProyectoNASN-GenGrupos.php">Generacion Grupos
                                        Usuarios</a></li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/PROCEDIMIENTO GENERACIÓN GRUPOS USUARIOS N+ FOROTV.pdf"
