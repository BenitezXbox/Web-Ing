...
<head>
    ...
    <title>Proyecto NAS N+ UTP Management</title>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item" href="ProyectoNASN-FiberChannel.php">Conexión de
                                        Fibre Channel </a></li>
                                <li><a class="dropdown-item active" href="ProyectoNASN-UTP-Management.php">Conexión UTP
                                        Management</a></li>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/Summit X450.pdf" class="w-100" frameborder="0"></iframe>
