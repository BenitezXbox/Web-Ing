...
<head>
    ...
    <title>Proyecto NAS N+ Nodos 2B</title>
...
">Quantum H400 Documentation Center</a>
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a class="dropdown-item active" href="ProyectoNASN-Nodos2B.php">Nodos UTP 2B</a>
                    ...
                    <div class="card-body p-2">
                        ...
                        <div class="row p-3 pb-4 justify-content-center">
                            ...
                            <div id="miPDF" class="row p-3  justify-content-center">
                                ...
                                <iframe src="../Doc/Nodos 2B.pdf" class="w-100" frameborder="0"></iframe>
