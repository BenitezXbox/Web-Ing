...
<body>
    ...
    <?php
include '../includes/HeaderMonitoreohome.php'
?>
                ...
                <div class="col-auto">
                    ...
                    <div class="collapse navbar-collapse" id="navbaring">
                        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" href="Monitoreo_Materiales.php">Monitoreo Envio Materiales TUDN</a>
                            </li>
            ...
            <article class="col mb-3">
                <div class="card">
                    ...
                    <div class="card-img-overlay text-white d-flex flex-column justify-content-center">
                        <h4>Monitoreo de materiales.</h4>
                        <p>
                            Puede consultar los diferentes envíos.
                        </p>
                    </div>
                </div>
            </article>
